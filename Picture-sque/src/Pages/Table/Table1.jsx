...
export default function BasicTable() {
  ...
  const d=(email) => {
    ...
    try{
      Axios.post("https://backend-0sjh.onrender.com/deletecrs", {
  ...
  useEffect(() => {
    Axios.get(`https://backend-0sjh.onrender.com/getcrs`)
      .then((res) => {
        setUsers(res.data);
            ...
            <TableBody style={{ color: "white" }}>
              {users.map((user) => (
                ...
                >
                  ...
                  <TableCell align="left"> <a href={user.file} target="_blank"> <img src={user.file} className="image1"/></a></TableCell>
